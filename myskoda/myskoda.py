...
class MySkoda:
    ...
    _callbacks: dict[Vin, list[Callable[[Vin], Coroutine[Any, Any, None] | Callable[[], Coroutine[Any, Any, None]]]]
    ...
    def subscribe_updates(
        self, vin: Vin, callback: Callable[[Vin], Coroutine[Any, Any, None] | Callable[[], Coroutine[Any, Any, None]]
    ) -> None:
